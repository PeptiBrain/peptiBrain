...
7. ✅ Rate limit ACTIVO en local y probado con tráfico real (2026-07-21) — falta pegar `UPSTASH_REDIS_REST_URL` y `UPSTASH_REDIS_REST_TOKEN` en Vercel (ya están en `.env.local`) + redeploy, para que también proteja producción.
