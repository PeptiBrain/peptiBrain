...
- **Rate limit** (60 peticiones/min por IP + bloqueo de 5 min si se excede) vía Upstash Redis — construido pero INACTIVO hasta que el usuario cree la cuenta gratis de Upstash y pegue las 2 env vars (ver pendientes abajo).
